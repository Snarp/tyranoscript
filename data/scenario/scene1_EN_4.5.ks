...
;Adjust the area where characters are displayed
...
;Character area where the character's name is displayed
[ptext name="chara_name_area" layer="message0" color="white" size=24 x=50 y=410]

;Declares that the area defined above is the name display of the character (without this, an error will occur in the # part)
[chara_config ptext="chara_name_area"]

;Declare the characters that appear in this game
;akane
[chara_new  name="akane" storage="chara/akane/normal.png" jname="Akane"  ]
;Character facial expression registration
...
#
Well, I heard it was easy to make a game, so I came here...[p]
...
;FIXME: In English, all the whitespace is stripped out of the button text, giving you "Yes,Iam." and "Iguessso..."
[glink  color="blue"  storage="scene1.ks"  size="20"  x="260"  width="400"  y="100"  text="Yes, I am."  target="*selectinterest"  ]
[glink  color="blue"  storage="scene1.ks"  size="20"  x="260"  width="400"  y="170"  text="Absolutely!"  target="*selectinterest"  ]
[glink  color="blue"  storage="scene1.ks"  size="20"  x="260"  width="400"  y="240"  text="I guess so..."  target="*selectinterest"  ]
[s  ]
*selectinterest
...
;Change the display position of the name
...
Also, by default, you can save and load from the button at the bottom right of the screen, but --[p]
-- If you want to customize the window...[p]
...
;; End of roll button addition


-- You can lay the game functions out across the screen like this.[p]
This is called a "roll button", and it allows for special functions,[p]
as well as the standard ones: [l]
Save, [l]
Load, [l][cm]
Return To Title, 
Show Menu, 
